...
`wordsは6〜8個。実際のその食べ物を分解するとこうなる、というワードを用意してください。含まれている食材をメインにして、足りなければその食べ物に含まれている栄養・物語・色・歴史・科学・季節など多様なカテゴリからワードをチョイスして。子供が「えっ、なんで？」と興味を持てるような意外なつながりを優先してください。`;
